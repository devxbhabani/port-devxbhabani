...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative w-full bg-black text-white py-24 px-6 border-t border-zinc-800">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16">
        <div className="md:w-1/2">
          ...
          <div className="flex flex-col gap-4 text-zinc-300 font-medium">
            <a href="https://linkedin.com/in/bhabanisankarjana" target="_blank" rel="noreferrer" className="hover:text-white transition-colors underline underline-offset-4">LinkedIn</a>
            <a href="https://github.com/devxbhabani" target="_blank" rel="noreferrer" className="hover:text-white transition-colors underline underline-offset-4">GitHub</a>
          </div>
        </div>
        ...
        <div className="md:w-1/2 flex items-center">
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-6">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <button type="submit" className="flex items-center justify-center w-16 h-16 rounded-full bg-white text-black hover:scale-110 transition-transform">
                <Send size={24} />
              </button>
            </div>
          </form>
